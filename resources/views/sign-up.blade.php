      ...
      <div class="collapse navbar-collapse d-flex" id="navigation">
        ...
        <div class="ms-auto d-flex align-items-center">
          <li class="nav-item d-flex align-items-center">
            <a class="btn btn-round btn-sm mb-0 btn-outline-white me-2" target="_blank" href="https://create.microsoft.com/es-es/templates/acta">Ver minutas</a>
          </li>
          <ul class="navbar-nav d-lg-block d-none">
            <li class="nav-item">
              <a href="https://apps.apple.com/mx/app/minutes/id1483067743" target="_blank" class="btn btn-sm btn-round mb-0 me-1 bg-gradient-dark">Descargar app</a>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-5 text-center mx-auto">
              ...
              <p class="text-lead text-white">Utilice estos increíbles formularios para iniciar sesión o crear una nueva cuenta en su proyecto de forma gratuita.</p>
            </div>
          </div>
        </div>
      </div>
