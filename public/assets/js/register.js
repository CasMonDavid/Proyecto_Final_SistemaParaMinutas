document
    ...
    .addEventListener("submit", async function (event) {
        ...
        if (/[A-Z]/.test(email)) {
            showCustomAlert(
                "El correo electrónico no puede contener mayúsculas.",
                "error"
            );
            return;
        }
        ...
        if (!email.endsWith("@gmail.com")) {
            showCustomAlert(
                "El correo electrónico debe pertenecer al dominio gmail.com.",
                "error"
            );
            return;
        }
        ...
        try {
            ...
            if (response.ok) {
                ...
                //Login
                window.location.href = "/home.post"; // Redirección en caso de to
            } else {
